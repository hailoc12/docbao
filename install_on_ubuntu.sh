...
sudo cp $install_dir/resources/firefox_driver/ubuntu/crawl.py $install_dir/backend/lib
sudo cp $install_dir/resources/configs/templates/default/config.txt $install_dir/backend/input
