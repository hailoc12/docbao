...
###########################################
    ...
    while continue_test:
        ...
        # test
        config_manager = ConfigManager(get_independent_os_path(['input', 'test.yaml']), get_independent_os_path(['input', 'kols_list.txt']), get_independent_os_path(['input', 'fb_list.txt']))
        config_manager.load_data()
        config_manager.replace_crawl_list([webconfig]) 
        data_filename = get_independent_os_path(['data','test_article.dat'])
        blacklist_filename = get_independent_os_path(['data','test_blacklist.dat'])
...
# MAIN PROGRAM
config_manager = ConfigManager(get_independent_os_path(['backend', 'input', 'config.yaml']),
                              get_independent_os_path(['backend', 'input', 'kols_list.txt']), 
                              get_independent_os_path(['backend', 'input', 'fb_list.txt'])) #config object
